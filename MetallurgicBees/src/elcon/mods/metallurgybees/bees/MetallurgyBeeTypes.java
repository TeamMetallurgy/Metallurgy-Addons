...
public enum MetallurgyBeeTypes {
	...
	BRONZE("bronze", true,         			new MBColors(132, 80, 32, 94, 56, 23), new MBColors(186, 112, 44, 132, 80, 32), new MBColors(225, 175, 130, 186, 112, 44), new MBColors(225, 175, 130, 132, 80, 32)),
	...
	HEPATIZON("hepatizon",true, 			new MBColors(97, 78, 97, 73, 58, 73), new MBColors(148, 122, 148, 97, 78, 97), new MBColors(180, 160, 180, 148, 122, 148), new MBColors(180, 160, 180, 97, 78, 97)),
	DAMASCUS_STEEL("damascusSteel", true,   new MBColors(88, 63, 44, 65, 47, 33), new MBColors(153, 109, 77, 88, 63, 44), new MBColors(223, 205, 191, 153, 109, 77), new MBColors(223, 205, 191, 153, 109, 77)),
	ANGMALLEN("angmallen", true,			new MBColors(207, 190, 71,156, 142, 41), new MBColors(225, 215, 138, 207, 190, 71), new MBColors(235, 227, 177, 225, 215, 138), new MBColors(235, 227, 177, 207, 190, 71)),
	...
	STEEL("steel", true,					new MBColors(136, 136, 136, 104, 104, 104), new MBColors(173, 173, 173, 136, 136, 136), new MBColors(216, 216, 216, 173, 173, 173), new MBColors(216, 216, 216, 104, 104, 104)),
	...
	BRASS("brass", true,					new MBColors(101, 69, 20, 62, 43, 13), new MBColors(216, 150, 52, 101, 69, 20), new MBColors(236, 205, 159, 216, 150, 52), new MBColors(236, 205, 159, 101, 69, 20)),
	...
	ELECTRUM("electrum", true,				new MBColors(185, 153, 70, 100, 83, 38), new MBColors(206, 184, 127, 185, 153, 70), new MBColors(223, 208, 170, 206, 184, 127), new MBColors(223, 208, 170, 185, 153, 70)),
	...
	SHADOW_STEEL("shadowSteel", true,		new MBColors(255, 255, 255, 255, 255, 255), new MBColors(255, 255, 255, 255, 255, 255), new MBColors(255, 255, 255, 255, 255, 255), new MBColors(255, 255, 255, 255, 255, 255)),
	...
	MetallurgyBeeTypes(String name, boolean alloy, MBColors rough, MBColors refined, MBColors reforged , MBColors comb) {
		this.name = name;
		this.alloy = alloy;
	...
	MetallurgyBeeTypes(String name, MBColors rough, MBColors refined, MBColors reforged , MBColors comb) {
		this(name, false, rough, refined, reforged, comb);
	}	
	
	public String name;
	public boolean alloy;
